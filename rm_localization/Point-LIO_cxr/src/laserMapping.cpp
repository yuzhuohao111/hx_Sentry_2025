...
public:
    LaserMappingNode(const rclcpp::NodeOptions& options = rclcpp::NodeOptions()) : Node("laser_mapping", options)
    {
        ...
        pubOdomAftMapped = this->create_publisher<nav_msgs::msg::Odometry>("/Odometry", 100000);//aft_mapped_to_init//Odometry
...
private:
    void readParameters()
    {
        ...
        this->declare_parameter<int>("init_map_size", 1000);  //10
        ...
        this->declare_parameter<double>("filter_size_surf",0.2);  //0.3
