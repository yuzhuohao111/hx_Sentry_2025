...
protected:
  ...
  rclcpp_lifecycle::LifecyclePublisher<visualization_msgs::msg::MarkerArray>::SharedPtr path_vehicles_pub_;
  ...
  visualization_msgs::msg::MarkerArray vehicle_boxes;
...
private:
     ...
     * @param path 包含路径的向量
     */
    void publishPathNodes(const std::vector<geometry_msgs::msg::PoseStamped>& path);
