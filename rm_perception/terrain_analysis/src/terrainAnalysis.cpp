...
void laserCloudHandler(
  ...
  // if(mode_.mode==1)
  // {
  //   // std::cout<<"mode_"<<mode_.mode<<std::endl;
  //   // 执行高度过滤
  //   pcl::PassThrough<pcl::PointXYZI> height_filter;
  //   height_filter.setInputCloud(laserCloud);
  //   height_filter.setFilterFieldName("z");
  //   height_filter.setFilterLimits(0.05,0.3);
  //   height_filter.setNegative(true);
  //   height_filter.filter(*laserCloud);

  //   pcl::PassThrough<pcl::PointXYZI> height_filter1;
  //   height_filter1.setInputCloud(laserCloud);
  //   height_filter1.setFilterFieldName("z");
  //   height_filter1.setFilterLimits(-0.2,0.0);
  //   height_filter1.setNegative(true);
  //   height_filter1.filter(*laserCloud);
  // }
...
int main(int argc, char **argv) {
  ...
  auto subLaserCloud = nh->create_subscription<sensor_msgs::msg::PointCloud2>(
      "processed_cloud", 10, laserCloudHandler);
